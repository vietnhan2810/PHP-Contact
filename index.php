<?php 
	...
	$result = mysqli_query($con, 'SELECT count(idma) as total FROM ma');
					...
					<tr>
						...
						<td>
							<div class="d-flex justify-content-center">
								<a class="text-white btn btn-warning mr-2" href="update.php?ma=<?php echo $row['idma']; ?>"><i class="fas fa-edit"></i> Edit</a>
								<a onclick="return confirm('Bạn có thực sự muốn xóa nó')"; class="text-white btn btn-danger" href="delete.php?ma=<?php echo $row['idma']; ?>"><i class="fas fa-trash-alt"></i> Delete</a>
							</div>
						</td>
					</tr>
				<?php 
